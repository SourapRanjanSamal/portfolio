...
const CustomHead = ({ title }) => {
  return (
    <Head>
      ...
      <meta
        name="description"
        content="Sourap Ranjan Samal is an avid full stack web developer building websites and applications you'd love to use"
      />
      <meta
        name="keywords"
...
CustomHead.defaultProps = {
  title: 'Sourap Ranjan Samal | Full Stack Developer',
};
